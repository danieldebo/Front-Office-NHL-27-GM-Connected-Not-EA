...
const COLLIDING_NAMES = new Set([
  'ListGamesParams',
  // CP1/CP2 — path-param wrapper schemas
  'GetLeagueParams',
  'GetLeagueHubParams',
  ...
  'RemoveGmParams',
  'GetRulebookParams',
  'PublishRulebookParams',
  'GetRulebookRevisionsParams',
  'GetStandingsParams',
  'GetGameParams',
  'ReportResultParams',
  'ConfirmResultParams',
  // CP3 — body schemas that Orval generates as both Zod consts and TS types
  ...
  'PostponeGameBody',
  'PostponeGameParams',
  'PostponeGameResponse',
  'ForceResolveGameBody',
  'ForceResolveGameBodyResolution',
  'ForceResolveGameParams',
  'ForceResolveGameResponse',
  'SetAvailabilityBody',
  'SetAvailabilityParams',
  'SetAvailabilityResponse',
  'GetMyAvailabilityParams',
  'GetMyAvailabilityResponse',
  'GetGameOverlapParams',
  'GetGameOverlapResponse',
  'AvailabilitySlot',
  'AvailabilitySlotBlock',
  // CP4 — discovery + feedback
  'ListOpenLeaguesParams',
  'ListOpenLeaguesResponse',
  'SignupForLeagueBody',
  'SignupForLeagueParams',
  'SignupForLeagueResponse',
  'JoinLeagueWaitlistParams',
  'JoinLeagueWaitlistResponse',
  ...
  // CP69 — request-validation schemas that also have generated TS interfaces.
