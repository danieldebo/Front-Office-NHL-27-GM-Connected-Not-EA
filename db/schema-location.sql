...
VALUES ('1.8.1', 'User location + country; surfaced on waitlist and applicant views')
...
ALTER TABLE app_user
    ADD COLUMN IF NOT EXISTS location TEXT; -- self-entered region, e.g. 'Chicago, IL'
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE conrelid = 'league_signup'::regclass
          AND conname = 'signup_country_format'
    ) THEN
        ALTER TABLE league_signup
