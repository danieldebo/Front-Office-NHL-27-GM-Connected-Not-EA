...
| `db/schema-keepers.sql` | Keepers, NHL player registry, stat cards (Phase 2) |
| `db/schema-discovery.sql` | Open leagues, ranked division, hidden rating, waitlist (Phase 3) |
| `db/schema-platform.sql` | League type enum: Xbox / PlayStation / Crossplay (Phase 1) |
...
| `design/team-admin-keepers-mockup.html` | Keeper page reference (slots, registry search, stat cards) |
| `design/open-leagues-mockup.html` | Discovery page + sign-up + persistent footer reference |
...
| `docs/keeper-addendum.md` | Keepers, player registry, stat cards. Phase 2 |
| `docs/registry-sync-spec.md` | NHL API sync + stat-card refresh jobs. Phase 2 |
| `docs/discovery-addendum.md` | Open leagues, sign-up, ranking, waitlist, footer. Phase 3 |
